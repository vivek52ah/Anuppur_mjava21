...
(function ($) {
        ...
        actionsbox =
          '<div class="bs-actionsbox">' +
            '<div class="btn-group btn-group-sm btn-block">' +
              '<button type="button" class="actions-btn bs-select-all btn ' + classNames.BUTTONSUCCESS + '">' +
                this.options.selectAllText +
              '</button>' +
              '<button type="button" class="actions-btn bs-deselect-all btn ' + classNames.BUTTONDANGER + '">' +
  ...
  function Plugin (option) {
    ...
    if (version.major === '4') {
      ...
      classNames.BUTTONSUCCESS = 'btn-success';
      classNames.BUTTONDANGER = 'btn-danger';
